...
<html lang="en">
    ...
    <body style="margin: 0;font-family: 'Poppins', sans-serif;background: #ffffff;font-size: 14px;">
        <div
            style="max-width: 680px;margin: 0 auto;padding: 45px 30px 60px;background: #f4f7ff;background-image: url(https://archisketch-resources.s3.ap-northeast-2.amazonaws.com/vrstyler/1661497957196_595865/email-template-background-banner);background-repeat: no-repeat;background-size: 1000px 710px;background-position: top center;font-size: 14px;color: #434343;">
            <header>
                <table style="width: 100%;">
                    <tbody>
                        <tr style="height: 0;">
                            <td>
                                <img alt="" width="150px"
                                    src="https://i.imghippo.com/files/fjZBx1711090619.png" />
                            </td>
                            <td style="text-align: right;">
                                <span
                                    style="font-size: 16px; line-height: 30px; color: #ffffff;"><?php echo 'Date : ' . date('d-F-Y'); ?></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <main>
                <div
                    ...
                    <div style="width: 100%; max-width: 489px; margin: 0 auto;">
                        ...
                        <p style="margin: 0;margin-top: 17px;font-weight: 500;letter-spacing: 0.56px;">
                            ...
                            Do not share this code with others, including BookMyTickets employee.
                        </p>
                        <p
                ...
                <p
                    ...
                    Need help? Ask at
                    <a href="mailto:bookmyticketadmin@gmail.com"
            ...
            <footer
                ...
                <p style="margin: 0; margin-top: 16px; color: #434343;">
                    Copyright © {{ date('Y') }} by bookmyticket.com, All rights reserved.
                </p>
            </footer>
        </div>
    </body>

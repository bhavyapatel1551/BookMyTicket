                            ...
                            <form action="" id="otp-form" method="post">
                                ...
                                <div class="flex items-center justify-center gap-3">
                                    <input type="text" name="d1"
                                        class="w-14 h-14 text-center text-2xl font-extrabold text-slate-900 bg-slate-100 border border-solid hover:border-slate-200 appearance-none rounded p-4 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"

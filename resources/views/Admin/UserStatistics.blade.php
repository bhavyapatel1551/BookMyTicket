<x-app-layout>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <div class="container-fluid py-4 px-5">
            ...
            {{-- End of User Details Card --}}

            {{-- Start of Paid User Table  --}}
            <div class="container-fluid pt-4 px-4">
                                ...
                                <tbody>
                                    @foreach ($paidUsers as $index => $user)
                                        <tr class="justify-content-center" id="zoomin">
                                            ...
                                            <td class="text-left">
                                                <p class="text-sm text-dark ms-3 mb-0 max-width-100">{{ $user->name }}
                                                </p>
                                            </td>
                                            ...
                                            <td class="align-middle text-center p-3">
                                                <p class="text-sm text-dark max-width-100  mb-0">{{ $user->created_at }}
                                                </p>
                                            </td>
                                            <td class="align-middle text-center p-3 ">
                                                <p class="text-sm text-dark  mb-0">
                                                    {{ $user->email_verified_at ? 'Yes' : 'No' }}</p>
                                            </td>
                                            <td class="align-middle text-center p-3 ">
            ...
            {{-- End of Paid User Table  --}}

            {{-- Start of Unverified Users Table  --}}
            <div class="container-fluid pt-4 px-4">
                <div class="bg-gray-200 text-center border-radius-lg p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    @foreach ($unverifiedUsers as $index => $user)
                                        <tr class="justify-content-center" id="zoomin">
                                            ...
                                            <td class="align-middle">
                                                <p class="text-sm text-dark ms-3 mb-0 text-center">{{ $user->name }}
                                                </p>
                                            </td>
                                            <td class="align-middle text-center p-3">
                                                <p class="text-sm text-dark max-width-100  mb-0">{{ $user->email }}
                                                </p>
                                            </td>
                                            <td class="align-middle text-center p-3">
